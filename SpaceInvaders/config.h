...
private:
    ...
    // Swarm list storing the different level aliens
    QList<QList<SwarmInfo>> swarmListLevel ={};
    QList<int> levelNumberList = {0};
    //int levelnumber = 0;
...
public:
    ...
    ~Config();
    QString get_name();
    int getSwarmMaxLevel(){return swarmList.size() - 1;}
    double get_scale();
    int get_startpos();
